...
class BackendConfig:
    ...
    def from_env(
        ...
        *,
        ...
        # Preserve the upstream OpenAI SDK's ten-minute request window for
        # Azure; Codex uses a shorter inactivity window with activity resets.
        default_timeout = "240" if selected == "codex" else "600"
        ...
        retries = min(
            3,
            max(1, int(values.get("CHEMEAGLE_LLM_MAX_ATTEMPTS", values.get("CHEMEAGLE_LLM_MAX_RETRIES", "3")))),
        )
